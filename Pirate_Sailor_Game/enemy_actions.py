...
def is_adjacent(position_one, position_two):
    """
    THIS FUNCTION HAS BEEN PROVIDED FOR YOU: DO NOT CHANGE.

    Determines whether two positions are adjacent to each other (including
    diagonals).
    :param position_one: coords
    :type position_one: tuple
    :param position_two: coords
    :type position_two: tuple
    :return: whether the two positions are adjacent (or the same)
    :rtype: bool
    """
...
def has_caught_player(enemy_position, player_position):
    ...
    NOTE: For this resit, this function should simply call the 'is_adjacent'
    function above, and return the result. This can be achieved in one line of
    code, but you have to call the function correctly and pass it the correct
    parameters.

    :param enemy_position: co-ordinates of enemy
    :type enemy_position: tuple
    :param player_position: co-ordinates of player
...
def move_enemy(grid, old_enemy_position, new_enemy_position):
    ...
    grid[old_enemy_position[0]][old_enemy_position[1]] = "."
    grid[new_enemy_position[0]][new_enemy_position[1]] = "P"
    return new_enemy_position
...
def kill_enemy(grid, old_enemy_position, new_enemy_position):
    ...
    grid[old_enemy_position[0]][old_enemy_position[1]] = "."
    grid[new_enemy_position[0]][new_enemy_position[1]] = "W"
    return new_enemy_position
